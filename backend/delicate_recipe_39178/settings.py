"""
Django settings for delicate_recipe_39178 project.
...
ROOT_URLCONF = 'delicate_recipe_39178.urls'
...
WSGI_APPLICATION = 'delicate_recipe_39178.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "delicate_recipe_39178 API",
    "DESCRIPTION": "API documentation for delicate_recipe_39178 App",
    "VERSION": "v1",
}
